...
public class ConexionBD {
  ...
  /**
   * Dada una sentencia de sql se encarga de crear el procidimiento almacenado,
   * esta sentencia debe ser de la forma
   * "CREATE OR REPLACE FUNCTION nombre(parametros) returns tipo as $$ consulta $$"
   * @param sentencia La sentencia de sql para crear el procedimiento almacenado
   * @throws SQLException Si la conexion no esta activa.
   */
  public void crearPA(String sentencia) throws SQLException {
    stmt.execute(sentencia);
  ...
  public static void main(String args[]) throws ClassNotFoundException, SQLException {
    ConexionBD conn = InterfazBD.getConexion();
    conn.conectarBD();
    conn.desconectarBD();
  }
